...
// انتظر تحميل LiveKit UMD حتى 12 ثانية (عادة يتم خلال أقل من ثانية)
...
async function join() {
  try {
    // ✅ تأكد من تحميل livekit قبل أي استدعاء لها
...
(function init() {
  ...
  // زر الخروج مربوط أيضاً في common.js — هذا احتياط إضافي
